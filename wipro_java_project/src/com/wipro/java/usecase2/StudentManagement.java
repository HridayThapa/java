...
public class StudentManagement 
{
	public static void main(String[] args) 
	{
		...
		while(true)
		{
			System.out.println("_Student Management System_");
			System.out.println();
			...
			int choice = sc.nextInt();
			 ...
			 switch (choice) {
             case 1:
                 System.out.println("_Add Student Details_");
             ...
             case 3:
            	 System.out.println();
                 System.out.println("_Displaying all students_");
             ...
             case 10:
                 System.out.println("_Exiting the application. Thank you!_");
                 sc.close();
                 return;

             default:
                 System.out.println("_Invalid choice! Please try again.");
         }
